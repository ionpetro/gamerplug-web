    ...
    <div className="min-h-screen bg-background text-white relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-5xl px-4 py-20 sm:py-28">
        <div className="mb-16 text-center">
          <div className="mx-auto h-8 w-36 rounded-full bg-white/10 sm:animate-pulse" />
          <div className="mx-auto mt-6 h-12 w-64 rounded-lg bg-white/10 sm:animate-pulse" />
          <div className="mx-auto mt-4 h-6 w-80 max-w-full rounded-lg bg-white/10 sm:animate-pulse" />
        </div>
        ...
        <div className="mb-20 grid grid-cols-1 gap-4 sm:grid-cols-3 sm:items-end">
          {Array.from({ length: 3 }).map((_, i) => (
            <div
              key={i}
              className={`rounded-2xl border border-white/10 bg-white/[0.03] p-8 sm:animate-pulse ${i === 1 ? 'sm:-mt-6' : ''}`}
            >
          ...
          <div className="space-y-2 p-4">
            {Array.from({ length: 8 }).map((_, i) => (
              <div key={i} className="grid grid-cols-[56px_1fr_120px] items-center gap-3 rounded-xl px-2 py-3">
                <div className="h-8 w-8 rounded-lg bg-white/10 sm:animate-pulse" />
                <div className="h-5 w-40 rounded bg-white/10 sm:animate-pulse" />
                <div className="justify-self-end h-7 w-16 rounded-full bg-white/10 sm:animate-pulse" />
              </div>
            ))}
          </div>
        </div>
