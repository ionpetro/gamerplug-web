...
export const FeatureCard = ({ icon, title, description, delay, comingSoon }: FeatureCardProps) => (
  <div className="p-8 rounded-2xl bg-card border border-border hover:border-primary/50 transition-all duration-300 group cursor-default relative overflow-hidden">
